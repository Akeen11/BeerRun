...
namespace BeerRun.Controllers
{
    public class PaymentTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PaymentTypeId,DateCreated,CardType,AccountNumber,UserId")] PaymentType paymentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentTypeId,DateCreated,CardType,AccountNumber,UserId")] PaymentType paymentType)
        {
